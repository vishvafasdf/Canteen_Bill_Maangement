...
def abc():
    ...
    heading1 = Label(root, text="NGI Canteen", font="Italic 48 bold", fg="red")
    heading2 = Label(root, text="NGI ", font="arial 18 bold", fg="blue")
    ...
    headl = Label(frame4, text="NGI Canteen", bg="#96C3EB", font="arial 12 bold ")
    ...
    root.title("NGI Canteen Bill counter")
    # root.iconbitmap('C:\PE PBL\\viit-logo-01.ico')
    root.mainloop()
...
ram = Tk()
heading3 = Label(ram, text="NGI", font="Italic 18 bold", fg="red")
heading4 = Label(ram, text="NGI Canteen", font="arial 48 bold", fg="blue")
heading5 = Label(ram, text='''Welcome to NGI canteen. So Enjoy Food delightfully.
...
ram.title("NGI Canteen Management")
